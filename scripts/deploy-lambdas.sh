...
FUNCS=(
  ...
  "admin/listUsers|listCognitoUsers|{DUMMY=1}"
  "admin/createUser|createCognitoUser|{DUMMY=1}"
  "admin/toggleUser|toggleCognitoUser|{DUMMY=1}"
  "admin/deleteUser|deleteCognitoUser|{DUMMY=1}"
  "admin/updateUser|updateCognitoUser|{DUMMY=1}"
